...
phrase_one = "Controlar la complejidad es la esencia de la programación"
print(phrase_one[0:10])

# Toma cada tercer caracter empezando desde el noveno hasta el final de la frase, e imprime el resultado
phrase_two = "Nunca confíes en un ordenador que no puedas lanzar por una ventana"
print(phrase_one[10:-1:3])
