...
num2 = 72 / 2
num3 = 48
mi_bool = (num1 > num2) or (num1 < num3) # True
print(mi_bool)


"""

Práctica Operadores Lógicos 3 Verifica si las palabras: palabra1 = "éxito", y palabra2 = "tecnología" no se encuentran en la frase a continuación, y almacena el resultado de esta comprobación (un booleano) en una variable llamada mi_bool: "Cuando algo es lo suficientemente importante, lo haces incluso si las probabilidades de que salga bien no te acompañan" 
...
mi_bool = (palabra1 in phrase) and (palabra2 in phrase)
print(mi_bool)
